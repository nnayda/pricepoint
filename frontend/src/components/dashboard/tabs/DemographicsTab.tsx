    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-2">
              {demographics.race_ethnicity.map((d) => (
                <div key={d.label} className="flex items-center gap-2">
                  ...
                  <span className="w-20 text-xs text-[var(--color-db-text-secondary)]">{d.label}</span>
                  <span
        ...
        <DashboardCard>
          ...
          <ResponsiveContainer width="100%" height={180}>
            <BarChart data={demographics.age_distribution} margin={{ top: 5, right: 10, left: 10, bottom: 5 }}>
              ...
              <Bar dataKey="female" name="Female" fill="#22D3EE" radius={[2, 2, 0, 0]} barSize={16} />
            </BarChart>
          </ResponsiveContainer>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <DashboardCard>
          ...
          <StatChip label="Median Income" value={`$${demographics.median_income.toLocaleString()}`} />
          <div className="mt-3 space-y-2">
            {demographics.income_brackets.map((b) => (
              <div key={b.label} className="flex items-center gap-2">
                <span className="w-16 text-[11px] text-[var(--color-db-text-muted)]">{b.label}</span>
                <div className="flex-1">
                  <div className="h-2 rounded-full bg-[var(--color-db-surface-alt)]">
                    <div
      ...
      <DashboardCard>
        ...
        <ResponsiveContainer width="100%" height={180}>
          <AreaChart data={demographics.population_trend} margin={{ top: 5, right: 10, left: 10, bottom: 5 }}>
            <defs>
            ...
            />
            <Area type="monotone" dataKey="population" stroke="#22D3EE" strokeWidth={2} fill="url(#popGradient)" />
          </AreaChart>
        </ResponsiveContainer>
      </DashboardCard>
    </div>
