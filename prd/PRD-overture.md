...
| File | Action |
|------|--------|
| `src/pricepoint/db/models.py` | Add 1 Overture model |
| `src/pricepoint/config/settings.py` | Add 2 Overture settings |
...
4. `make migration MSG="add overture places table"`
